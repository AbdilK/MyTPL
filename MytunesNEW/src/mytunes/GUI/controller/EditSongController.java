...
// This closes the EditSong window
    @FXML
    private void clickCancelEditSong(ActionEvent event) 
    {
        isEditing = false;
    ...
    @FXML
    private void clickSaveEditsSong(ActionEvent event) throws IOException // This saves that data that you put in the EditSong window
    {
        if (!isEditing) {
